...
func TestStatsD(t *testing.T) {
	...
	expected := []string{
		...
		"traefik.test-proxy." + GetHostName() + ".service.request.total:2.000000|c\n",
		"traefik.test-proxy." + GetHostName() + ".service.retries.total:2.000000|c\n",
		"traefik.test-proxy." + GetHostName() + ".service.request.duration:10000.000000|ms",
		...
		"traefik.test-proxy." + GetHostName() + ".service.server.up:1.000000|g\n",
	}
